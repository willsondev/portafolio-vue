...
/>
      ...
      <!--  más ProjectCard según sea necesario -->
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      `,
      firebaseIcon: `
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 600 600">
